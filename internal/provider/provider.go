...
func (p *graylogProvider) Resources(_ context.Context) []func() resource.Resource {
	return []func() resource.Resource{ NewStreamResource, NewInputResource, NewIndexSetResource }
}

func (p *graylogProvider) DataSources(_ context.Context) []func() datasource.DataSource { return nil }
